...
class ProfileReportController extends Controller
{
    public function __invoke(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'data' => [
                'from_date' => $fromDate,
                'to_date' => $toDate,
                'audio' => $this->speakerReport($userId, $fromDate, $toDate, $dates),
                'moderation' => $this->moderationReport($userId, $fromDate, $toDate, $dates),
            ],
        ]);
    }
     ...
     */
    private function speakerReport(int $userId, string $fromDate, string $toDate, array $dates): array
    {
        $stats = Audio::query()
     ...
     * @return array<string, mixed>
     */
    private function moderationReport(int $userId, string $fromDate, string $toDate, array $dates): array
    {
        $stats = Audio::query()
