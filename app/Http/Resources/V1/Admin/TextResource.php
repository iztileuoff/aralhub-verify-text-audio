...
class TextResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'has_text_error' => $this->has_text_error,
            'text_error_reported_by' => $this->text_error_reported_by,
            'text_error_reporter' => new UserResource($this->whenLoaded('textErrorReporter')),
            'text_error_reported_at' => $this->text_error_reported_at?->format('Y-m-d H:i:s'),
